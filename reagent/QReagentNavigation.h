...
class QReagentNavigation : public QNavigationPage
{
    Q_OBJECT

public:
    QReagentNavigation(QWidget *parent = Q_NULLPTR);
    ~QReagentNavigation();
...
private:
    ...
    ///
    void RegisterPageShell(PAGENAVIGATION type, const QString& name, const std::vector<CornerButtonInfo>& pageInfos);
};
