...
namespace Ui {
    class ImPumpModuleWgt;
};

class ImPumpModuleWgt : public QWidget
{
    Q_OBJECT

public:
    ImPumpModuleWgt(QWidget *parent = Q_NULLPTR);
    ~ImPumpModuleWgt();
...
private:
    ...
    const int                               m_ciToothedGearCmdCode;     // 齿轮泵命令码
};
