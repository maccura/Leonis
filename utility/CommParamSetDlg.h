...
class CommParamSetDlg : public BaseDlg
{
	Q_OBJECT

public:
	CommParamSetDlg(QWidget *parent = Q_NULLPTR);
	~CommParamSetDlg();
...
private:
	...
	///
	/// @par History:
	/// @li 7951/LuoXin，2022年10月14日，新建函数
	///
	bool CheckInputData();
