...
#include "ui_ImDevFacadeModuleWgt.h" 
#include "src/common/Mlog/mlog.h"
#include "shared/tipdlg.h"
#include "shared/msgiddef.h"
#include "shared/messagebus.h"

ImDevFacadeModuleWgt::ImDevFacadeModuleWgt(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::ImDevFacadeModuleWgt)
{
    ui->setupUi(this);
...
ImDevFacadeModuleWgt::~ImDevFacadeModuleWgt()
{
}

void ImDevFacadeModuleWgt::UpdateUi(const im::tf::DebugModule& stuTfDbgMd)
{
    // 调试模块
...
void ImDevFacadeModuleWgt::InitUi()
{
	
}

void ImDevFacadeModuleWgt::InitData()
{

}

void ImDevFacadeModuleWgt::InitConnect()
{
    // 获取所有复选框
    QList<QCheckBox*> allCbList = this->findChildren<QCheckBox*>();
...
///
void ImDevFacadeModuleWgt::OnCheckBoxClicked()
{
    // 获取信号发送者
