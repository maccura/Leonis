...
class QCaliBrationNavigation : public QNavigationPage
{
    Q_OBJECT

public:
    QCaliBrationNavigation(QWidget *parent = Q_NULLPTR);
    ~QCaliBrationNavigation();
    ...
    ///
    void RegisterPageShell(CALIBRATEPAGENAVIGATION type, const QString& name, const std::vector<CornerButtonInfo>& pageInfos);
	...
	///
	void RefreshCornerWidgets(int index);
};
