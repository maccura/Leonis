...
///////////////////////////////////////////////////////////////////////////
/// @file     C1005V1000DeviceWgt.h
/// @brief    C1005 1000速设备界面头文件
///
...
namespace Ui {
    class C1005V1000DeviceWgt;
};


class C1005V1000DeviceWgt : public QBaseDeviceWgt
{
	Q_OBJECT
...
public:
	...
	///
	C1005V1000DeviceWgt(const string &sn, const string &name, const EnumDeviceType &type,
