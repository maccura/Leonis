...
namespace Ui {
    class I6000DeviceWgt;
};

class I6000DeviceWgt : public QBaseDeviceWgt
{
	Q_OBJECT
...
public:
	...
	///
	I6000DeviceWgt(const string &sn, const string &name, const EnumDeviceType &type, 
